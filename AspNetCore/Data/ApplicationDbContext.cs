...
namespace AspNetCore.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"Server=SALTEDFISHXX\SQLEXPRESS;database=TimeSheetManagementSystemDB_Vue;Trusted_Connection=True;MultipleActiveResultSets=True");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //
            //TODO: Missing relationship code
            modelBuilder.Entity<AccountDetail>()
